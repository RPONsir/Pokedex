...
class PokemonGifWithNameLink extends StatelessWidget {
  ...
  const PokemonGifWithNameLink(
      this.pokemonId, this.pokemonName, this.pokemonType,
      {super.key});
    ...
    return Column(
      children: [
        PokemonGifVisualWithBackground(
          ...
          types: pokemonType,
          imageUrl: pokemonName[1].toString(),
        ...
        GestureDetector(
          ...
          child: Text(
            '#$pokemonId : ${pokemonName[0].toString().toUpperCase()}',
