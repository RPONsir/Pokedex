...
class PokemonGif extends StatefulWidget {
  ...
  const PokemonGif(this.imageUrl, this.imageUrl2, this.width, this.height,
      this.frontImage, this.scaleGif,
      {super.key});
  ...
  Widget build(
    ...
    return FadeInImage(
      ...
      image: CachedNetworkImageProvider(
        imageDisplayed,
        scale: widget.scaleGif,
      ),
      placeholder: const AssetImage("images/pokeLoader.gif"),
