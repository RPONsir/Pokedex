...
class PokemonRegionList extends StatefulWidget {
  ...
  const PokemonRegionList(
      {Key? key,
      required this.allPokemonList,
      required this.regionPokemonList,
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: PreferredSize(
          ...
          child: BuildPokemonSearcher(context, widget.allPokemonList,
              widget.regionPokemonList.length, widget.addValue),
        ),
        actions: [
          Container(
